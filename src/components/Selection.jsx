...
const Selection = () => {
  return (
    <div className="h-screen text-newblue ">
      <div
        className=" text-newblue hidden bg-hero5 bg-cover lg:bg-contain bg-right space-y-6 bg-newgray h-full lg:flex flex-col bg-no-repeat px-4 md:px-10 xl:px-20
       "
      >
        <h2 className="font-semibold text-5xl lg:text-6xl xl:text-6xl pt-4">
          Selection Process
        </h2>
