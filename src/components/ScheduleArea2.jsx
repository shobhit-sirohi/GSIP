...
const ScheduleArea2 = () => {
  return (
    <div className="bg-newgray px-4 md:px-10 xl:px-20 text-center text-newblue flex flex-col justify-center items-center pt-4 pb-20">
      <h2 className="font-semibold text-3xl  xl:text-4xl 2xl:text-5xl py-10 lg:w-4/5  ">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between pt-10 space-y-10 lg:space-y-0 ">
        <div className="bg-newblue lg:w-5/12 p-6">
