  ...
  return (
    <div className="bg-newgray flex flex-col h-auto text-center px-4 py-10 2xl:pb-20  md:px-10 xl:px-20 text-newblue ">
      ...
      <div className="grid lg:grid-cols-3 grid-cols-1 gap-x-20 gap-y-20 lg:gap-y-4 ">
        <span className="2xl:h-80 lg:h-60  text-2xl 2xl:text-3xl order-1">
          Experience a life-changing opportunity of working
          under industry experts and leaders and learning
          from them.
        </span>
        <span className="2xl:h-80  text-2xl 2xl:text-3xl lg:order-2 order-3">
        ...
        <span className="xl:h-80  text-2xl 2xl:text-3xl lg:order-3 order-5">
        ...
        <div className="bg-newblue flex flex-col p-6 xl:h-80  lg:h-auto justify-between lg:order-4 order-2">
          <img
            ...
            alt="vector"
          />
          <h2 className="text-white text-3xl 2xl:text-4xl font-medium">
            Learn real-world skills
          </h2>
        </div>
        <div className="bg-newblue flex flex-col p-6 2xl:h-80  lg:h-auto justify-between lg:order-5 order-4">
          <img
            src={vector2}
            className="2xl:h-32 h-28"
            alt="vector"
        ...
        <div className="bg-newblue flex flex-col p-6 2xl:h-80   lg:h-auto justify-between order-6 ">
          <img
            src={vector3}
            className="2xl:h-32 h-28"
            alt="vector"
